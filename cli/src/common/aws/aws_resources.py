...
class Stack:
    """Data object wrapping the result of a describe_stacks call."""
    ...
    def __init__(self, stack_name: str):
        ...
        self._outputs = self._stack_data.get("Outputs", [])
    ...
    def _get_output(self, output_key: str):
        return next((o.get("OutputValue") for o in self._outputs if o.get("OutputKey") == output_key), None)
